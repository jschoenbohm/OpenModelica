    ...
    package Analog  "Library for analog electrical models"
      ...
      package Basic  "Basic electrical components"
        ...
        model Resistor  "Ideal linear electrical resistor"
          parameter SI.Resistance R(start = 1) = 1 "Resistance at temperature T_ref";
      ...
      package Sources  "Time-dependent and controlled voltage and current sources"
        ...
        model SineVoltage  "Sine voltage source"
          parameter Real V(final quantity = "ElectricPotential", final unit = "V", start = 1) = 1 "Amplitude of sine wave";
          parameter SI.Angle phase = 0 "Phase of sine wave";
          parameter SI.Frequency freqHz(start = 1) = 1 "Frequency of sine wave";
